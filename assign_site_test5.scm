    ...
    (let ((tail nil))
      (begin
        (loop 1000
          (lambda ()
            (begin
              (let ((b (new-struct-instance-of-A A))
                    (c (new-struct-instance-of-A A))
                    (d (new-struct-instance-of-A A))
                    (e (new-struct-instance-of-A A))
                    (f (new-struct-instance-of-A A))
                    (g (new-struct-instance-of-A A))
                    (h (new-struct-instance-of-A A))
                ...
                (begin
                  ...
                  (set-field-of-A b "field1" c 45)
                  (set-field-of-A c "field1" d 46)
                  (set-field-of-A d "field1" e 47)
                  (set-field-of-A e "field1" f 48)
                  (set-field-of-A f "field1" g 49)
                  (set-field-of-A g "field1" h 50)
                  (set-field-of-A h "field1" i 51)
